...
START_TEST(matrix_create_test_2) {
  ck_assert_int_eq(s21_create_matrix(3, 3, NULL), ERROR);
}
END_TEST

START_TEST(matrix_create_test_3) {
  matrix_t A = {0};
  ck_assert_int_eq(s21_create_matrix(3, 0, &A), ERROR);
}
END_TEST

START_TEST(matrix_create_test_4) {
  matrix_t A = {0};
  ck_assert_int_eq(s21_create_matrix(0, 3, &A), ERROR);
}
END_TEST
...
START_TEST(matrix_create_test_6) {
  matrix_t A = {0};
  ck_assert_int_eq(s21_create_matrix(
